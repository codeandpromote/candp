          ...
          <div className="row g-4">
            <div className="col-12 col-md-6 col-lg-4">
              <div className="process-card-two">
                ...
                <p className="mb-0">
                  A data-driven approach to building tailored digital solutions
                  that align with your business objectives and market trends.
                </p>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="process-card-two">
                ...
                <p className="mb-0">
                  From front-end interfaces to robust back-end systems — we code
                  scalable, secure, and responsive websites and web apps.
                </p>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="process-card-two">
                ...
                <p className="mb-0">
                  Optimize engagement with automated campaigns, advanced
                  analytics, and personalized user journeys that boost ROI.
                </p>
              </div>
            </div>
          </div>
