              ...
              <div className="testimonial-slide">
                ...
                >
                  <SwiperSlide className="swiper-slide">
                    ...
                    <p>
                      “Working with Code and Promote was a game-changer for our
                      business. They didn’t just build our website – they
                      created a powerful online platform that truly reflects our
                      brand. The team was professional, responsive, and went
                      above and beyond to deliver exactly what we needed”
                    </p>
                    ...
                    <div className="testimonial-info d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p className="mb-0">Founder, TrendWear</p>
                      </div>
                    </div>
                  </SwiperSlide>
                  ...
                  <SwiperSlide className="swiper-slide">
                    ...
                    <p>
                      “From web maintenance to SEO, Code and Promote has been
                      our trusted partner in scaling our online presence. Their
                      team delivers consistent results and keeps our site fast,
                      secure, and visible in search rankings. Couldn’t ask for a
                      better tech partner.”
                    </p>
                    <div className="border-line"></div>
                    <div className="testimonial-info d-flex align-items-center">
                      ...
                      <div>
                        <h4>Jason Wood</h4>
                        <p className="mb-0">CEO, FoodieGo</p>
                      </div>
                    </div>
                  </SwiperSlide>
                  ...
                  <SwiperSlide className="swiper-slide">
                    ...
                    <p>
                      “Code and Promote helped us rebrand with a fresh, modern
                      website and compelling graphic designs. Their creativity
                      and technical expertise made the entire process smooth and
                      enjoyable. We now have a digital presence that truly
                      stands out.”
                    </p>
                    <div className="border-line"></div>
                    <div className="testimonial-info d-flex align-items-center">
                      ...
                      <div>
                        <h4>Andy Robarts</h4>
                        <p className="mb-0">Marketing Head, Luxe Interiors</p>
                      </div>
                    </div>
                  </SwiperSlide>
