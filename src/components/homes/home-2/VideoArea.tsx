...
const counter_data = [
  {
    ...
    description:
      "Delivering cutting-edge solutions that transform ideas into high-performing digital realities.",
  },
  {
    count: 427,
    label: "Successful Projects",
    description:
      "From startups to enterprises, our code builds brands and drives measurable growth.",
  },
  {
    count: 241,
    label: "Satisfied Customers",
    description:
      "Trusted by businesses across industries for innovation, precision, and results.",
  },
];
            ...
            >
              <div className="video-popup">
                <div className="popup-video">
                  <div
                    className="video-btn"
                    data-video="https://www.youtube.com/embed/jiJNU20Ue8E?si=nwMPhX63NsgJM3E1"
                  >
                    <svg
