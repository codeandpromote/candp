          ...
          >
            <SwiperSlide className="swiper-slide">
              <Link href="/web-development">
                ...
                <p className="mb-0">
                  web development services that create visually stunning, fast,
                  and user-friendly websites designed to boost your brand’s
                  online presence.
                </p>
              </Link>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide">
              <Link href="/web-maintenance">
                <div className="icon-wrapper">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50"
                ...
                <p className="mb-0">
                  Code and Promote provides reliable website maintenance
                  services to keep your site secure, updated, and performing at
                  its best for a seamless user experience.
                </p>
              </Link>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide">
              <Link href="/digital-marketing">
                ...
                <p className="mb-0">
                  Code and Promote delivers result-driven digital marketing
                  solutions that boost your online visibility, engage your
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/graphics-designing">
                ...
                <p className="mb-0">
                  Code and Promote creates visually stunning and impactful
                  graphic designs that capture your brand’s identity and leave a
            ...
            <SwiperSlide className="swiper-slide">
              <Link href="/mobile-app-development">
                ...
                <p className="mb-0">
                  High-performance mobile apps that deliver seamless experiences
                  and help your business grow in the digital world.
                </p>
              </Link>
            </SwiperSlide>
            <SwiperSlide className="swiper-slide">
