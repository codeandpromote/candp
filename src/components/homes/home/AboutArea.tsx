            ...
            <div className="col-12 col-md-6">
              <div className="about-us-text-content ps-md-4">
                <div className="section-heading">
                  <h2 className="mb-0">
                    Passionate About Powerful Digital Solutions
                  </h2>
                </div>
                <p className="mb-0">
                  If you ask our clients what it’s like working with us, they’ll
                  talk about how dedicated we are to helping them thrive online.
                  For us, success comes from crafting innovative digital
                ...
                <ul className="ps-0 list-unstyled mb-0">
                  <li>
                    ...
                    Custom Web Development That Performs
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    Smart Digital Marketing Strategies That Convert
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    SEO, PPC & Social Media — All Optimized for Growth
                  </li>
                </ul>

                <div>
                  <a href="/contact" className="btn btn-primary mt-1">
          ...
          <div className="container">
            <div className="row g-4 align-items-center">
              <div className="col-12 col-md-3">
                <h4 className="mb-0">
                  <span className="text-primary">2337+</span> Our Trusted &
                  Valuable Clients
                </h4>
              </div>
