            ...
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <div className="social-nav">
                  <a href="https://www.facebook.com/CodeandPromote">
                    <svg
                  ...
                  <a href="https://www.linkedin.com/company/code-and-promote-web-development-digital-marketing-agency">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <a href="https://www.instagram.com/_codeandpromote/">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
            ...
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <ul className="footer-nav">
                  ...
                  <li>
                    <a href="/mobile-app-development">Mobile Apps Design</a>
                  </li>
                  <li>
